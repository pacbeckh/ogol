...
public State baseState(real direction, bool pendown, str color,  Point position, Canvas canvas) {
	return <<direction,pendown,color, position>, canvas>;
}
...
test bool evalForwardLine1() = evalCommand((Command)`forward 100;`,() ,(), baseState(0.0,true,"#000000", <0.0,0.0>, [])) ==  <<0.0,true,"#000000",<0.0,100.0>>, [line(<0.0,0.0>,<0.0,100.0>, "#000000")]>;
...
test bool evalPenColor() = evalCommand((Command)`setpencolor #000000;`, (), (), baseState(0.0,false,"", <10.0,10.0>, [])) == <<0.0,false,"#000000",<10.0,10.0>>, []>;
